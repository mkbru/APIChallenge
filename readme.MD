...
The API is written using the Node.js/Express framework and MySQL.

The application is packaged in a Docker container and is running on Kubernetes and can be accessed on <ip>
